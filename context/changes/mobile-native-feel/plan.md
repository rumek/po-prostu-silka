...
- [x] 1.8 390px member: brand bar on Start, titled bars on tabs, back+title on exercise and Moje konto — 388511a
- [x] 1.9 390px trainer: titled Grafik/Członkowie, back + "Plan — {member}"
- [x] 1.10 Bar pinned while scrolling, hairline appears, no jump during transitions — 388511a
- [x] 1.11 Desktop unchanged apart from /my-plan heading — 388511a
- [x] 1.12 Installed Android: cream status bar and splash, dark status icons — 388511a
...
- [x] 2.6 Android: tab switches fade, back from a tab lands on Start, back from Start exits — 388511a
- [x] 2.7 Android: child slides forward, back arrow slides back, system back from tab root goes to Start — 388511a
- [x] 2.8 Deep-linked child: back arrow lands on parent without leaving the app — 388511a
- [x] 2.9 Trainer: search/paging does not slide; back closes bookings overlay; no phantom step after × — 388511a
- [x] 2.10 Desktop: header links and Wróć links behave sensibly with browser back — 388511a
